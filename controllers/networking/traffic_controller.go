...
//+kubebuilder:rbac:groups=networking.hybfkuf.io,resources=traffics,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=networking.hybfkuf.io,resources=traffics/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=networking.hybfkuf.io,resources=traffics/finalizers,verbs=update
...
func (r *TrafficReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&networkingv1alpha1.Traffic{}).
		Complete(r)
}
